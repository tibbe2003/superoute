...
class stepper2 extends StatefulWidget {
  ...
  String shelfId;
  stepper2(this.shelfLocation, this.shelfId, {Key? key}) : super(key: key);
...
class _stepper2State extends State<stepper2> {
  ...
  linkReq(String shelfId, String productId) async {
    final response = await http.post(
      Uri.parse('http://api.superoute.nl/v2/linkProduct/1'),
    ...
    if (response.statusCode == 200) {
      print("product successfully linked");
    } else {
